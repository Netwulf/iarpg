...
IIDE-FILE-RESOLUTION:
  ...
  - Dependencies map to .aios-infrastructure-devops/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → .aios-infrastructure-devops/tasks/create-doc.md
...
The complete agent definition is available in [.aios-infrastructure-devops/agents/infra-devops-platform.md](.aios-infrastructure-devops/agents/infra-devops-platform.md).
